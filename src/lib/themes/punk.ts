...
export const punk: ThemeDefinition = {
  ...
  generate: () => ({
    ...
    buttonSecondary: `bg-transparent text-purple-700 underline font-serif text-lg hover:bg-green-300 transition-none cursor-wait`,
    input: `bg-yellow-100 border-[3px] border-inset border-gray-400 text-black font-serif p-1`,
    card: `bg-white border-[3px] border-black p-4 shadow-[10px_10px_0px_magenta] mb-8 rotate-1 hover:rotate-0 transition-transform`,
